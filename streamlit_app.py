    ...
    with tabs[2]:
        ...
        try:
            ...
            st.subheader("📊 Radar Chart - Profils par *Dimension*")
                ...
                try:
                    # 1. Dictionnaire pour regrouper les sous-dimensions
                    dimension_groups = {
            ...
            st.error(f"Erreur du Radar Chart par Dimension : {e}")
